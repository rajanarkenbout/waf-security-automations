...
echo ""
echo "------------------------------------------------------------------------------"
echo "[Packing] Whitelist Parser"
echo "------------------------------------------------------------------------------"
cd ../whitelist-parser
zip -q -r9 ../../deployment/dist/custom/whitelist-parser.zip *
echo ""
echo "------------------------------------------------------------------------------"
echo "[Info] Installation instructions"
echo ""
echo "This cloudformation template expects the source code (Lambdas) to be stored in a S3 bucket appendend with the region name!"
echo "Ensure to run the shell script WITHOUT the region name appended."
echo ""
echo "  $1-ap-southeast-2.s3.amazonaws.com"
echo ""
echo "Ensure to copy the contents of the dist directory into a sub directory of the S3 bucket called \"aws-waf-security-automations\""
echo ""
echo "  $1-ap-southeast-2.s3.amazonaws.com/aws-waf-security-automations/"
echo ""
echo "------------------------------------------------------------------------------"

    ...
    try:
        ...
        if 'DELETE' in request_type and "UPDATE" in stack_status:
            ...
            for p in parameters:
                ...
                if p["ParameterKey"] == "ActivateWhitelistAutomationParam":
                    event['ResourceProperties']['ActivateWhitelistAutomation'] = p["ParameterValue"]
            ...
            if (event['ResourceProperties']['SqlInjectionProtection'] == "yes" or
                ...
                event['ResourceProperties']['ActivateBadBotProtection'] == "yes" or
                event['ResourceProperties']['ActivateWhitelistAutomation'] == "yes" ):
                request_type = 'UPDATE'
        #----------------------------------------------------------
